...
public class Paciente {
    ...
    public String toString() {
        return "Paciente{" + "id=" + id + ", ci=" + ci + ", nombre=" + nombre + ", paterno=" + paterno + ", materno=" + materno + ", fecha_nacimiento=" + fecha_nacimiento + ", sexo=" + sexo + ", telefono=" + telefono + ", direccion=" + direccion + ", ciudad=" + ciudad + ", correo=" + correo + ", id_recepcionista=" + id_recepcionista + ", recepcionista=" + recepcionista + '}';
    }
}
