...
<%
    ...
    sql = "SELECT COUNT(*) AS pacientes FROM PACIENTES";
    ps = conn.prepareStatement(sql);
    rs = ps.executeQuery();
    if (rs.next()) {
        pacientes = Integer.toString(rs.getInt("pacientes"));
    }
        ...
        <section class="full-box dashboard-contentPage">
            ...
            <div class="container-fluid">
                <div class="page-header">
                    <h1 class="text-titles">MEDI SANA<small> Administracion</small></h1>
                </div>
            </div>
