            ...
            <div class="container-fluid">
                ...
                <c:if test="${requestScope.action == 'edit'}" var="res" scope="request">
                    <c:forEach var="item" items="${lista_pacientes}">
                        <c:if test="${item.id == reserva.id_paciente}" var="sel">
                                            ...
                                            <div class="form-group" style="margin-top: 0px">
                                                ...
                                                <select name="id_doctor" class="form-control" requiered>
                                                    ...
                                                    <c:forEach var="item" items="${lista_doctores}">
                                                        <option value="${item.id}"
                                                                <c:if test="${item.id == reserva.id_doctor}" var="sel">
                                                                    selected
                                                                </c:if> >${item.nombre} ${item.paterno} ${item.materno}
                                                        </option> 
                                                    </c:forEach>
                                            ...
                                            <div class="form-group" style="margin-top: 0px; 
                                                ...
                                                <select name="observacion" class="form-control" requiered>
                                                    ...
                                                    <option value="Se presento"
                                                            <c:if test="${reserva.observacion == 'Se presento'}" var="sel">
                                                                selected
                                                            </c:if> >Se presento
                                                    </option>
                                                    <option value="No se presento"
                                                            <c:if test="${reserva.observacion == 'No se presento'}" var="sel">
                                                                selected
                                                            </c:if> >No se presento
                                                    </option>
                                                    <option value="Llego tarde"
                                                            <c:if test="${reserva.observacion == 'Llego tarde'}" var="sel">
                                                                selected
                                                            </c:if> >Llego tarde
                                                    </option>
                                                </select>  
