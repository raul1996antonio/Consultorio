...
<section class="full-box cover dashboard-sideBar">
    ...
    <div class="full-box dashboard-sideBar-ct">
        ...
        <div class="full-box text-uppercase text-center text-titles dashboard-sideBar-title">
            <a href="index.jsp"><span style="text-decoration: none;color: #fff;list-style: none;"> MEDI SANA </span></a><i class="zmdi zmdi-close btn-menu-dashboard visible-xs"></i>
        </div>
        <!-- SideBar User info -->
        <div class="full-box dashboard-sideBar-UserInfo">
            <figure class="full-box">
                <img src="./assets/avatars/medisana.png" alt="UserIcon">
                <br>
        ...
        <ul class="list-unstyled full-box dashboard-sideBar-Menu">
            <c:if test="${rol=='Administrador' || rol=='Doctor' || rol=='Recepcionista' || rol=='Paciente'}"> 
                <li>
            ...
            <c:if test="${rol=='Administrador' || rol=='Doctor' || rol=='Recepcionista'}">   
                <li>
            ...
            <c:if test="${rol=='Administrador' || rol=='Recepcionista' || rol=='Paciente'}">   
                <li>
            ...
            <c:if test="${rol=='Administrador'}"> 
                <li>
                    ...
                    <ul class="list-unstyled full-box">
                        ...
                        <li>
                            <a href="EstadoControlador"><i class="zmdi zmdi-card zmdi zmdi-hc-fw"></i> ESTADOS </a>
                        </li>
                        <li>
