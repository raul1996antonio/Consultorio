    ...
    <body>
        ...
        <section class="full-box dashboard-contentPage">
            ...
            <div class="container-fluid">
                ...
                <p class="lead">Lista de todas las recetas que dieron los doctores del consultorio.</p>
            </div>
                                ...
                                <tbody>
                                    <c:forEach var="item" items="${recetas}">
                                        <tr>
                                            ...
                                            <c:if test="${rol=='Administrador'}">
                                                <td>                                                                    
                                                    <a href="RecetaControlador?action=edit&id=${item.id}" class="btn btn-success btn-raised btn-xs">
                                                        <i class="zmdi zmdi-edit"></i>
                                                    </a>
                                                </td>

                                                <td>
                                                    <a href="RecetaControlador?action=delete&id=${item.id}" class="btn btn-danger btn-raised btn-xs" onclick='return confirm("¿Estas seguro de eliminar la receta \"${item.id}\"?")'>
